$(function(){
    ...
    //3depth를 추가 합니다.
    var threeDepthTitle = [];
    threeDepthTitle[0] = ["회사비전", "회사개요"];
    threeDepthTitle[1] = ["C.I 콘셉트", "기본 시스템"];
    threeDepthTitle[2] = ["찾아오시는 길", "업무별 담당자"];
    ...
    $("nav>ul>li:eq(0)>ul>li").eq(5).append("<ul class='threeDepth threeDepth03'><li><a href='#'>" + threeDepthTitle[2][0] + "</a></li><li><a href='#'>" + threeDepthTitle[2][1] + "</a></li></ul>");
