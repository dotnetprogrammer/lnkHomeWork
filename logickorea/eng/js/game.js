$(function(){
	...
	popScreenshot += "<a href='#' class='btn_prev'><img src='./img/screenshot_btn_prev.gif' alt='Prev' title='Prev' /></a>";
	popScreenshot += "<a href='#' class='btn_next'><img src='./img/screenshot_btn_next.gif' alt='Next' title='Next' /></a>";
	popScreenshot += "<img src='./img/screenshot_btn_close.gif' alt='Close' title='Close' class='btn_close' />";
